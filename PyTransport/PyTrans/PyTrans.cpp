...
#include"/home/gsalinas/GitHub/PyTransportSU/PyTransport/CppTrans/NC/evolve.h"//evolve
#include"/home/gsalinas/GitHub/PyTransportSU/PyTransport/CppTrans/NC/moments.h"//moments
#include"/home/gsalinas/GitHub/PyTransportSU/PyTransport/CppTrans/NC/model.h"//model
#include"/home/gsalinas/GitHub/PyTransportSU/PyTransport/CppTrans/stepper/rkf45.hpp"//stepper
//************************************************************************************************* 
...
// Package recompile attempted at: Mon Mar 20 17:12:55 2023
...
// **************************************************************************************    
static struct PyModuleDef PyTransModule = {PyModuleDef_HEAD_INIT, "PyTransAngular", PyTrans_docs, -1, PyTransAngular_methods}; //modDef
// do not alter the comment at the end of preceeding line -- it is used by preprocessor
    
// **************************************************************************************
PyMODINIT_FUNC PyInit_PyTransAngular(void)    {    PyObject *m = PyModule_Create(&PyTransModule); import_array(); return m;} //initFunc
// do not alter the comment at the end of preceeding line -- it is used by preprocessor
